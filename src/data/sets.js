/**
 * This file exports an array which contains all of the
 * possible sets which are included in the pokemon api.
 *
 * Note that the 'id' key has been changed to 'value'
 * and the 'name' key has been changed to 'label', because
 * these key names played more nicely with the set filter
 * dropdown component.
 */
...
export default [
  ...
  {
    value: "swsh9tg",
    label: "Brilliant Stars Trainer Gallery",
    series: "Sword \u0026 Shield",
    printedTotal: 30,
    total: 30,
    legalities: {
  ...
  {
    value: "swsh10tg",
    label: "Astral Radiance Trainer Gallery",
    series: "Sword \u0026 Shield",
    printedTotal: 30,
    total: 30,
    legalities: {
